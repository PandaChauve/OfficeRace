...
declare module PIXI {
    ...
    */
    export class TilingSprite extends Sprite {
        ...
        * Removes all references to transformCallbacks, its parent, the stage, filters, bounds, mask and cached ressources.
        */
        destroy(): void;
    ...
    * 
    * __Hint__: All DisplayObjects (i.e. ressources) that render to a RenderTexture should be preloaded otherwise black rectangles will be drawn instead.
    * 
